...
def create_error(request):
    ...
    if serialized_error.is_valid():
        ...
        return Response(serialized_error.data, status=status.HTTP_201_CREATED) # si esta bien creado = 201
    return Response(serialized_error.errors, status=status.HTTP_400_BAD_REQUEST) # si esta mal este
